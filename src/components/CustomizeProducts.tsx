...
const CustomizeProducts = () => {
    return (
        ...
        <ul className="flex items-center gap-3">
            <li className='ring-1 ring-rafi text-rafi rounded-md py-1 px-4 text-sm cursor-pointer'>small</li>
            <li className='ring-1 ring-rafi text-white bg-rafi rounded-md py-1 px-4 text-sm cursor-pointer'>Medium</li>
